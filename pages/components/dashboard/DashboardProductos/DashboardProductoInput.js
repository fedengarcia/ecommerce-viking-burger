...
export default function DashboardProductoInput ({setReload, reload,title,propType,placeholderValue,productId}){
    ...
    return(<div className='dashboard-input'>
            ...
            {inputProp === propType ?
                <TextField className="title-dash-prod-item" size="small" autoComplete="off" color="secondary"  id="nameId"  placeholder={placeholderValue} type="text" onChangeCapture={handleChangeData}/>
